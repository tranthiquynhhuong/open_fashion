...
class AppFooter extends StatelessWidget {
  ...
  Widget _buildMoreNavigate(BuildContext context) {
    return Row(
      ...
      children: [
        TextButton(
          onPressed: () => onAboutPressed ?? push(context, createAbout()),
          child: const TText(
            'About',
        ...
        Padding(
          ...
          child: TextButton(
            onPressed: () => onContactPressed ?? push(context, createContact()),
            child: const TText(
              'Contact',
              style: St.body_L_16_regular,
            ),
        ...
        TextButton(
          onPressed: () => onBlogPressed ?? push(context, createBlog()),
          child: const TText(
            'Blog',
            style: St.body_L_16_regular,
          ),
